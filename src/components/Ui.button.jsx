function Button({
  ...
  const styleClasses =
    styleType === "primary"
      ...
      : "border light:border-[#C4841D] dark:border-[#F5A524] light:text-[#C4841D] dark:text-[#F5A524] bg-transparent hover:bg-[#C4841D] hover:bg-opacity-10 dark:hover:bg-[#F5A524] dark:hover:text-white dark:hover:bg-opacity-10";
