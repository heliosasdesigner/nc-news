...
function Container({ listData, isListLoading, listError }) {
  return (
    <main className="flex flex-col px-12 justify-center mx-auto w-max-[1440px]">
      <section className="flex flex-wrap gap-4 box-border mx-auto">
        <Outlet />
      </section>
      <section className="flex flex-col box-border my-8 border-t border-gray-500 w-max-[1440px] w-[80%] mx-auto">
        <ContentList
          listData={listData}
